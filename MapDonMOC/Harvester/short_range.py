...
path_base = "/home/mapdadmin/data/nwm_data"+ "/short_range/"+ yesterday_str
metadata_dict={}
...
for lines in response.readlines():
    ...
    #print(value)
           ...
           #print(filename)
           if(('land' in filename) or ('reservoir' in filename) or (('f006' not in filename) and ('f012' not in filename) and ('f018' not in filename) )):
                       continue
